...
//	dom.children().eq(0).css('height','auto');//æ¨¡å—è‡ªé€‚åº”
	...
	var adaptModuleAfter = dom.children('div').eq(0).height();//è‡ªé€‚åº”ä¹‹åŽé«˜åº¦
	...
	var moduleHeight = dom.children('div').eq(0).outerHeight();//æ¨¡å—å– wp-æ¨¡å—å_contentå±‚çš„é«˜åº¦
